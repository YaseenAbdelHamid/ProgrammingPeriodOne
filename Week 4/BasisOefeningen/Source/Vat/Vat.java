...
/**
 * De klasse Vat is bedoeld om vloeistof te bevatten.
 * Er zijn 2 attributen: inhoud (=actuele inhoud) en capaciteit (=maximale inhoud).
 */
public class Vat {
    private int inhoud;  // = 0
    private int capaciteit;  // 0
    ...
    /**
     * Verwijdert een bepaalde hoeveelheid uit het vat
     */
    public void verwijder(int hoeveelheid) {
        if (hoeveelheid < 0) {
            System.out.println("De te verwijderen hoeveelheid mag niet negatief zijn!");
        } else {
